...
export default {
  ...
  data() {
    return {
      appTitle: "ระบบการจัดเก็บข้อมูลการมีงานทำของนักศึกษา",
      sidebar: false,
      search: "",
      desserts: [],
      headers: [
        ...
        { text: "จังหวัด", value: "company_province" },
        { text: "ค่าเบี้ยเลี้ยง", value: "company_allowance" },
        { text: "เงินเดือนที่ได้รับ", value: "company_salary" },
        { text: "ข้อมูลการทำงาน", value: "not_experience" },
