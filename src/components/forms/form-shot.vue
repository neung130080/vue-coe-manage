<template>
  <v-card style="font-family: 'Kanit', sans-serif">
    ...
    <div class="text-center">
      ...
      <h2>Rajabhat Maha Sarakham University</h2>
      <br />
      <p>
    ...
    <v-container fluid>
      ...
      <v-row>
        ...
        <v-radio-group v-model="form.company_allowance" row>
          <v-radio label="มี/have" value="มี" />
          <v-radio label="ไม่มี/without" value="ไม่มี" />
        </v-radio-group>
      </v-row>
      <v-row>
        <v-col cols="2">
          <v-subheader>
            <p class="font-weight-black">เบี้ยเลี้ยงที่ได้รับ /<br />Allowance received</p>
          </v-subheader>
        </v-col>
        <v-radio-group v-model="form.company_salary" row>
          <v-radio label="น้อยกว่า 10k" value="น้อยกว่า 10k" />
          <v-radio label="10k-15k" value="10k-15k" />
           <v-radio label="20k-25k" value="20k-25k" />
            <v-radio label="30k-35k" value="30k-35k" />
             <v-radio label="40k-50k" value="40k-50k" />
        </v-radio-group>
      </v-row>
      <v-row>
        <v-col cols="12">
      ...
      axios
        ...
        .then((resp) => {
          ...
          if (data.length > 0) {
            ...
            this.form.company_salary = data[0].company_salary;
